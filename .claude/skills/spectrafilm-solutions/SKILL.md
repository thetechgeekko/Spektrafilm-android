...
| 3 | **Look is "too punchy"** vs scanned film; wants to mute contrast/sat; couplers opaque | nosle/okke: too contrasty; ggoncalo: couplers unclear | 0+2 | ⚠️ tone curve exists; sat/contrast buried |
| 4 | **Gamut artifacts** — hard cyan edge in sRGB, skin tones off, foliage too warm; want ACES RGC | arctic: sat *"cannot fit in sRGB gamut"*; cyan "explosion" | 2 | ⚠️ output-space choice helps; no gamut compress |
