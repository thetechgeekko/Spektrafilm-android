...
| 3 | **Look is "too punchy"** vs scanned film; wants to mute contrast/sat; couplers opaque | nosle/okke: too contrasty; ggoncalo: couplers unclear | 0+2 | ✅ **Contrast** (`ContrastCurve.kt`) + **Saturation/Vibrance** (`ColorGrade.kt`, Oklab); ⚠️ couplers relabel (§3.3) still pending |
