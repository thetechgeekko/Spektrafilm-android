...
The new P2 #5 PR's subscription + any cron die when the session ends — re-subscribe / re-arm if wanted.

---

## State (2026-06-09, branch `claude/exciting-hamilton-hya62`) — White-balance wave + **release prep v0.8.0** (PR #103)
