...
param(
    ...
    # regenerate every pair in $pairs, which is almost never what a single change wants.
    [string]$Shader
)
...
# shader silently churns the other pairs and detaches them from the device
